 ...
 *
 * @author Jiaji Hu, using code from Dan Klein
 */

public class IdentityCounterMap<K, V> {
  ...
  public static void main(String[] args) {
    IdentityCounterMap<String, String> bigramCounterMap = new IdentityCounterMap<String, String>();
